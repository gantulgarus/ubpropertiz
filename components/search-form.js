...
const SearchForm = (props) => {
  ...
  return (
    <form className="h_search_form" onSubmit={props.handleSubmit}>
      <div className="row_one">
        ...
        {/* <pre>{JSON.stringify(props.propertyTypes, null, 2)}</pre> */}
        ...
        <label className="checkbox">
          ...
          <span className="checkbox_content">
            ...
            <span className="checkbox_text">Орон сууц</span>
          </span>
        </label>
        <label className="checkbox">
          <input type="checkbox" />
          <span className="checkbox_content">
            ...
            <span className="checkbox_text">Газар</span>
          </span>
        </label>
        <label className="checkbox">
          <input type="checkbox" />
        ...
        <label className="checkbox">
          ...
          <span className="checkbox_content">
            ...
            <span className="checkbox_text">Хашаа байшин</span>
          </span>
        </label>
        <label className="checkbox">
          <input type="checkbox" />
        ...
        <div className="select_wrap">
          ...
          <div className="form_select_wrap">
            <select
              name="status"
              id="search_status"
              value={props.searchPropertyStatus}
              onChange={handleStatusChange}
            >
              <option value="">Статус сонгох</option>
              {props.propertyStatus.map((status) => (
        ...
        <div className="select_wrap">
          ...
          <div className="form_select_wrap">
            <select
              name="type"
              id="search_type"
              value={props.searchPropertyType}
